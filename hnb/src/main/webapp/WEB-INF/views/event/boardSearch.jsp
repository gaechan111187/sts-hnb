...
<TABLE id="pagenation">
	...
	<TR>
		...
		<TD WIDTH=320 ALIGN=CENTER>
			...
			<a href="${context}/event/boardList/1"><IMG SRC="${img}/btn_bf_block.gif"></a>
		...
		<TD WIDTH=200 ALIGN=RIGHT style="color: black;">
		<FORM NAME="memberSearch" METHOD=POST action="${context}/event/memberSearch/1">
